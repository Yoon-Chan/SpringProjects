...
class ArticleServiceTest {
    ...
    @Test
    void givenSearchParameters_whenSearchingArticlesViHashtag_thenReturnsEmptyPage() {
        // Given
        Pageable pageable = Pageable.ofSize(20);
    ...
    @Test
    void givenHashtag_whenSearchingArticlesViHashtag_thenReturnsArticlesPage() {
        // Given
        String hashtag = "#java";
        Pageable pageable = Pageable.ofSize(20);
